...
| Phase 6: 6502 Y register foundation and Y-counter instruction slice | #46 | qc | `docs/epics/0046-y-register-slice.md` | `Y`, `LDY`, `INY`, `DEY`, `CPY`, `STY`, assembler/CLI/docs, awaiting issue-sync before closure |
