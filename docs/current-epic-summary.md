...
- Open follow-up from last epic: none known after #45 closure
...
- For a new multi-task feature or domain change: use epic mode.
- Before any CPU/opcode work: read `docs/6502-domain-rules.md`.

## Context Files
- Workflow index: `docs/agentic-epic-flow.md`
