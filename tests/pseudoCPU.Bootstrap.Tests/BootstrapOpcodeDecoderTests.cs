...
public class BootstrapOpcodeDecoderTests
{
    ...
    [InlineData(0xA5, BootstrapOpcode.LdaZeroPage)]
    [InlineData(0xB5, BootstrapOpcode.LdaZeroPageX)]
    [InlineData(0xBD, BootstrapOpcode.LdaAbsoluteX)]
    [InlineData(0xB9, BootstrapOpcode.LdaAbsoluteY)]
    [InlineData(0xA6, BootstrapOpcode.LdxZeroPage)]
    [InlineData(0xB6, BootstrapOpcode.LdxZeroPageY)]
    [InlineData(0xBE, BootstrapOpcode.LdxAbsoluteY)]
    [InlineData(0xA4, BootstrapOpcode.LdyZeroPage)]
    [InlineData(0xB4, BootstrapOpcode.LdyZeroPageX)]
    [InlineData(0xBC, BootstrapOpcode.LdyAbsoluteX)]
    [InlineData(0x85, BootstrapOpcode.StaZeroPage)]
    [InlineData(0x95, BootstrapOpcode.StaZeroPageX)]
    [InlineData(0x9D, BootstrapOpcode.StaAbsoluteX)]
    [InlineData(0x99, BootstrapOpcode.StaAbsoluteY)]
    [InlineData(0x6C, BootstrapOpcode.JmpIndirect)]
    [InlineData(0xA1, BootstrapOpcode.LdaIndexedIndirect)]
    [InlineData(0x81, BootstrapOpcode.StaIndexedIndirect)]
    [InlineData(0xB1, BootstrapOpcode.LdaIndirectIndexed)]
    [InlineData(0x91, BootstrapOpcode.StaIndirectIndexed)]
    [InlineData(0x86, BootstrapOpcode.StxZeroPage)]
    [InlineData(0x96, BootstrapOpcode.StxZeroPageY)]
    [InlineData(0x84, BootstrapOpcode.StyZeroPage)]
    [InlineData(0x94, BootstrapOpcode.StyZeroPageX)]
